(function () {
  ...
  function localStorageBackup() {
    ...
    if (localStorage.mmHeaderfixed) {
      let html = document.querySelector("html");
      html.setAttribute("data-header-position", "fixed");
    }
    if (localStorage.mmHeaderscrollable) {
      let html = document.querySelector("html");
      html.setAttribute("data-header-position", "scrollable");
    }
    if (localStorage.mmMenufixed) {
      let html = document.querySelector("html");
      html.setAttribute("data-menu-position", "fixed");
    }
    if (localStorage.mmMenuscrollable) {
      let html = document.querySelector("html");
      html.setAttribute("data-menu-position", "scrollable");
    }
    if (localStorage.mmMenu) {
      let html = document.querySelector("html");
      let menuValue = localStorage.getItem("mmMenu");
      switch (menuValue) {
        case "light":
    ...
    if (localStorage.mmHeader) {
      let html = document.querySelector("html");
      let headerValue = localStorage.getItem("mmHeader");
      switch (headerValue) {
        case "light":
